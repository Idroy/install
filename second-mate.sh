...
mkdir $HOME/.icons/Numix-Circle
mkdir $HOME/.icons/Numix-Circle-Light
mkdir $HOME/.icons/Numix
mkdir $HOME/.icons/Numix-Light
cp -r $HOME/install/numix-icon-theme-circle/Numix-Circle $HOME/.icons/Numix-Circle
cp -r $HOME/install/numix-icon-theme-circle/Numix-Circle-Light $HOME/.icons/Numix-Circle-Light
cp -r $HOME/install//numix-icon-theme/Numix $HOME/.icons/Numix
cp -r $HOME/install/numix-icon-theme/Numix-Light $HOME/.icons/Numix-Light
